...
<html lang="en">
  ...
  <head>
    ...
    <title>Recover password - Easy link</title>
...
<body>
      <!--NAVIGATION-->
      <?php require_once "assets/includes/headers.php"; ?>
      ...
      <section class="log-cont forms">
        ...
        <div class="form login">
          <div class="form-content">
            ...
            <p>
                Please enter one time password (OTP) and your new password to reset your password
            </p>

            <form action="assets/config/reset_config" method="post">
              <div class="field input-field mb-3">
                <input type="number" name="_token" autocomplete="off" autofocus placeholder="Enter your OTP code..." class="input">
                <input type="password" name="_password" autocomplete="off" placeholder="Enter your new password..." class="input my-2">
              </div>

              <div class="field button-field mt-5">
                <button type="submit" name="reset" class="mt-4">Recover password</button>
              </div>
            </form>
          </div>
        </div>
