...
function progress($row,$check){
    if($row['order_status'] === $check){echo "blue"; }else{echo "green";}
}
function progressIcon($row,$check){
if($row['order_status'] === $check){echo "text-white"; }
}
$curId = $_SESSION['id'];
...
<body>
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu rounded-0 lh-lg" aria-labelledby="dropdownMenuLink">
                        ...
                        <li><a href="orders?filter=1" class="dropdown-item" style="font-size: 13px;" href="#">Accepted Orders</a></li>
                        <li><a href="orders?filter=2" class="dropdown-item" style="font-size: 13px;" href="#">Shipped Orders</a></li>
                        <li><a href="orders?filter=3" class="dropdown-item" style="font-size: 13px;" href="#">Delivered Orders</a></li>
                        <li><a href="orders?filter=4" class="dropdown-item" style="font-size: 13px;" href="#">Canceled Orders</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-borderless main">
                    ...
                    <?php
                        ...
                        $cql = "SELECT * FROM tbl_cart WHERE _id = '" . $row['cart_id'] . "'";
                    ...
                    ?>
                        <tr class="rounded bg-white">
                            ...
                            <td>
                                <?php
                                    checkStatus($row,"0","Placed");
                                    checkStatus($row,"1","Accepted");
                                    checkStatus($row,"2","Shipped");
                                    checkStatus($row,"3","Deliverd");
                                    checkStatus($row,"4","Canceled");
                                ?>
                            </td>
                            <td class="text-center">
                                <?php echo $crow['quantity']; ?>
                            </td>
                            <td class="text-nowrap">₦ <?php echo number_format($crow['total'], 2, '.', ','); ?></td>
                            <td>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <img src="../assets/img/products/<?php echo getName($connectDB, "product_image", "product_image", "product_id", $crow['product_id']); ?>" class="lightboxed" height="150" alt="Phone">
                                                    ...
                                                    <p class="text-muted mb-0">
                                                        ₦ <?php echo number_format($crow['total'], 2, '.', ','); ?>
                                                    </p>
                                                    </div>
                                                    ...
                                                    <p class="small mb-0"><?php echo ucwords($row['user_address']); ?></p>
                                                    </div>
                                                    <div class="d-flex justify-content-between mt-3">
                                                    <p class="small mb-0">Shipping: </p>
                                                    <p class="small mb-0">₦ 1,575.00</p>
                                                    </div>
                                                    <div class="d-flex justify-content-between">
                                                    <p class="fw-bold">Total</p>
                                                    <p class="fw-bold" style="color: #35558a;">₦ <?php echo number_format($crow['total'] + 1575, 2, '.', ','); ?></p>
                                                    </div>
                                                    <div class="my-3">
                                                    <!-- Timeline Starts -->
                                                    <div class="progressbar-track">
                                                        <ul class="progressbar">
                                                        <li id="step-1" class="text-muted <?php progress($row,"0"); ?>">
                                                            <span class="fas fa-gift <?php progressIcon($row,"0"); ?>"></span>
                                                        </li>
                                                        <li id="step-2" class="text-muted <?php progress($row,"1"); ?>">
                                                            <span class="fas fa-check <?php progressIcon($row,"1"); ?>"></span>
                                                        </li>
                                                        <li id="step-4" class="text-muted <?php progress($row,"2"); ?>">
                                                            <span class="fas fa-truck <?php progressIcon($row,"2"); ?>"></span>
                                                        </li>
                                                        <li id="step-5" class="text-muted <?php progress($row,"3"); ?>">
                                                            <span class="fas fa-box-open <?php progressIcon($row,"3"); ?>"></span>
                                                        </li>
                                                        </ul>
                                                        <div id="tracker"></div>
                                                    </div>
                            ...
                            <td><?php if(!empty($row['date_updated'])){ echo date_format(date_create($row['date_updated']), "D, d M. Y"); }  ?></td>
                            <td>
                                <div class="dropdown">
            ...
            <div class="bg-light rounded-top p-4">
                <div class="row">
                    <div class="col-12 col-sm-6 text-center text-sm-start">
                        &copy; <a href="../index">EASY LINK</a>, All Right Reserved.
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Back to Top -->
    <a href="#" style="background-color: rgb(96, 74, 235); color: white;" class="btn btn-lg btn-lg-square back-to-top"><i class="bi bi-arrow-up"></i></a>
    </div>
    <style>
        #catImg {
            height: 300px;
