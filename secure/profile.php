            ...
            <div class="bg-light rounded h-100 p-4">
                ...
                <div class="table-responsive">
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col"><span style="color: red;">NOTE:</span> Dear customer, we would appreciate if you are very specific with your address, given that the location provided is where your orders will be delivered. NOTE that you can add as many addresses as you like, but the one you select while placing your order, is the location where the item(s) will be delivered. Thank you. <br><br>Your addresses will display below. <i class="fas fa-arrow-down"></i></th>
                                <th scope="col">...</th>
                            </tr>
                        </thead>
                        <tbody>
        ...
        <div class="bg-light rounded-top p-4">
            <div class="row">
                <div class="col-12 col-sm-6 text-center text-sm-start">
                    &copy; <a href="#">EASY LINK Ltd</a>, All Rights Reserved.
                </div>
