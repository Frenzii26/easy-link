...
<head>
  ...
  <title>Shopping Cart - Easy Link</title>
              ...
              <div class="row g-0">
                    ...
                    ?>
                      <div class="row mb-4 d-flex justify-content-between align-items-center">
                        ...
                        <div class="col-md-3 col-lg-3 col-xl-3">
                          ...
                          <h6 class="text-black mb-0"><?php echo substr(ucwords(getName($connectDB, "product_name", "tbl_products", "product_id", $row['product_id'])), 0, 30) . '...'; ?></h6>
                        </div>
                        ...
                        <div class="col-md-3 col-lg-2 col-xl-2 position-relativ" id="subTotal<?php echo $row['_id']; ?>">
                          <h6 class="mb-0">₦ <?php echo number_format($row['total'], 2, '.', ','); ?> </h6>
                        </div>
                ...
                <div class="col-lg-4 bg-grey">
                  <div class="p-5">
                    ...
                    <h5 class="text-uppercase mb-3">Apply promo code</h5>
                    ...
                    <div class="d-flex justify-content-between mb-5">
                      ...
                      ?>
                      <h5 id="grandTotal">₦ <?php echo number_format($nrow['grand_total'], 2, '.', ','); ?></h5>
