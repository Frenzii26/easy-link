<?php 
    ...
    function errorMessage(){
        if (isset($_SESSION['errormessage'])) {
           $message = "<div class=\"alert text-center fw-bold alert-danger position-fixed end-0\" style=\"top: 19%;\" role=\"alert\">";
    ...
    function successMessage(){
        if (isset($_SESSION['successmessage'])) {
            $message = "<div class=\"alert text-center fw-bold alert-success position-fixed end-0\" style=\"top: 19%;\" role=\"alert\">";
