...
<head>
    ...
    <title>Privacy Policy - Easy Link</title>
        ...
        <div id="priv-body">
          <p class="ques" id="q1">1.) About our privacy and cookies page</p>
              <span class="priv-spans">
                This page is here to provide you with information on how we at Easy link.com.ng, collect and use your personal
              ...
              <span class="priv-spans">
                We collect personal information like email address, Name, phone number, address, present location, banking details,
                 When you create an account with Easy link.com.ng . Although you are able to browse most
              ...
              <span class="priv-spans">
                By definition (wikipedia), cookies or HTTP cookies rather, are small blocks of data created by a web server 
              ...
              <p class="ques" id="q4">4.) How we collect your data</p>
              <span class="priv-spans">
              ...
              <p class="ques" id="q5">5.) How we use your data</p>
              <span class="priv-spans">
                Easy link.com.ng uses the information collected from you to: <br>
                <ul>
              ...
              <p class="ques" id="q6">6.) How we share your data and with whom</p>
              <span class="priv-spans">
              ...
              <p class="ques" id="q7">7.) How to opt-out of our data collection</p>
              <span class="priv-spans">
                We provide our users with the opportunity to opt-out of certain communication from us after registration.
                If you want to remove all your data from all Easy link.com.ng lists and newsletters, you can unsubscribe by
