...
if (isset($_POST['newProduct'])) {
    ...
    $sql = "INSERT INTO tbl_products(product_id,product_name,cat_id,sub_id,price,stock,details) VALUES(?,?,?,?,?,?,?)";
    // Initialize Database Connection
    $stmt = mysqli_stmt_init($connectDB);
    // Prepare SQL statement
    mysqli_stmt_prepare($stmt, $sql);
    // Bind parameters to the placeholder
    mysqli_stmt_bind_param($stmt, "sssssss", $pid, $title, $cat, $sub, $price, $stock, $details);
    // Execute statement
