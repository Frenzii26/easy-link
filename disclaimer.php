...
<head>
    ...
    <title>Disclaimer - Easy Link</title>
      ...
      <section class="container">
        <div id="priv-body">
              <span class="priv-spans">
                This is to inform you that Easy Link in no way took part in the production of the products sold on
                this site. As a result of that would also like to inform you that any factory faults or damages on any of our 
                sold products should be returned by customer in question for repair by our calcare services. At the same time 
                repairs for damages made after sale, will be paid for by customer, in a case where product in question hasn't 
