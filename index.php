...
<body class="body">
      ...
      <!--HOME-->
      <section id="home" style="background-image: url(assets/img/home/superiorhome4.jpg);">
        <!--SEARCH-->
        ...
        <p style="color: rgb(96, 74, 235);">Easylink offers you high quality, and affordable devices.</p>
      ...
      <section id="new" class="w-100">
            <div class="row p-0 m-0">
              ...
              ?>
              <div class="col-lg-4 col-md-12 col-12" id="catIndex">
      ...
      <section id="featured-p" class="my-5 pb-5">
            <div class="container text-center mt-5 py-5">
              <a href="shop"><h3>Our Products</h3></a>
            </div>
