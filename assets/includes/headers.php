...
<section id="header">
  <a href="index" class="index-logo"><img src="assets/img/logo/easylink logo trans.png" alt=""><span id="index-span">Easylink</span></a>
  <div>
    <ul id="navbar">
        ...
        <li>
          <div class="dropdown ">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="<?php if($_SESSION['role'] != 'admin'){echo 'profile';}else{echo 'secure/profile';} ?>">Profile</a></li>
